  ...
  return (
    <div className="flex flex-col min-h-screen bg-black text-white">
      ...
      <div className="flex items-center px-4 py-4 sticky top-0 bg-black z-10">
        <button
          onClick={() => navigate(-1)}
          className="text-white hover:bg-gray-900 rounded-full p-1 -ml-1 transition absolute"
        >
          <svg
      ...
      <div className="flex flex-col px-4 pt-4 pb-10">
        {/* KAST */}
        <h3 className="text-gray-300 text-sm mb-3 ml-1 tracking-wide uppercase">
          Kast
        </h3>
        ...
        <div className="bg-[#111111] rounded-2xl flex flex-col mb-8 overflow-hidden">
          ...
          <Link
            to="/receive/usd"
            className="flex items-center justify-between p-4 border-b border-gray-800/50 active:bg-gray-900 transition"
          >
            <div className="flex items-center gap-4">
              <div className="w-8 h-8 rounded-full overflow-hidden flex-shrink-0">
                <svg viewBox="0 0 60 40" className="w-full h-full object-cover" preserveAspectRatio="xMidYMid slice">
                  ...
                  <path
                    fill="#fff"
                    d="M0 3.1h60v3.1H0zM0 9.2h60v3.1H0zM0 15.4h60v3.1H0zM0 21.5h60v3.1H0zM0 27.7h60v3.1H0zM0 33.8h60v3.1H0z"
                  />
                  <path fill="#192f5d" d="M0 0h25v21.5H0z" />
                  <path
                    fill="#fff"
                    d="M1.5 2.1l1 3 3.1-.1-2.5 1.8 1 3-2.6-1.9-2.5 1.9 1-3-2.6-1.8 3.1.1z"
                  ...
                  <path
                    fill="#fff"
                    d="M1.5 2.1l1 3 3.1-.1-2.5 1.8 1 3-2.6-1.9-2.5 1.9 1-3-2.6-1.8 3.1.1z"
                    transform="scale(0.8) translate(19,0)"
                  />
                  <path
                    fill="#fff"
                    d="M1.5 2.1l1 3 3.1-.1-2.5 1.8 1 3-2.6-1.9-2.5 1.9 1-3-2.6-1.8 3.1.1z"
          ...
          <Link
            to="/receive/eur"
            className="flex items-center justify-between p-4 active:bg-gray-900 transition"
          >
            <div className="flex items-center gap-4">
              <div className="w-8 h-8 rounded-full overflow-hidden flex-shrink-0 bg-[#003399] flex items-center justify-center">
                <svg viewBox="0 0 24 24" className="w-full h-full">
                  ...
                  <g transform="translate(12,12)">
                    <g id="star-sm">
                      <polygon
                        points="0,-1.2 0.35,-0.35 1.2,-0.35 0.52,0.18 0.78,0.98 0,0.45 -0.78,0.98 -0.52,0.18 -1.2,-0.35 -0.35,-0.35"
                        fill="#FFCC00"
                      />
                    </g>
                    <use href="#star-sm" x="0" y="-5.5" />
                    <use href="#star-sm" x="2.75" y="-4.76" />
                    <use href="#star-sm" x="4.76" y="-2.75" />
                    <use href="#star-sm" x="5.5" y="0" />
                    <use href="#star-sm" x="4.76" y="2.75" />
                    <use href="#star-sm" x="2.75" y="4.76" />
                    <use href="#star-sm" x="0" y="5.5" />
                    <use href="#star-sm" x="-2.75" y="4.76" />
