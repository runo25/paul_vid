    ...
    <div className="flex flex-col h-screen text-white pb-20 bg-gradient-to-b from-[#0f3e34] via-black to-black" style={{ backgroundSize: '100% 50%', backgroundRepeat: 'no-repeat', backgroundColor: 'black' }}>
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-6">
        ...
        <div className="grid grid-cols-4 gap-3 mb-6">
          ...
          <Link to="/pagar" className="bg-[#111111] rounded-[20px] p-4 flex flex-col items-center justify-center gap-2 aspect-square hover:bg-[#1a1a1a] transition">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-6 h-6">
              <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 19.5 15-15m0 0H8.25m11.25 0v11.25" />
            </svg>
            <span className="text-[13px] font-medium">Pagar</span>
          </Link>
          <Link to="/scan" className="bg-[#111111] rounded-[20px] p-4 flex flex-col items-center justify-center gap-2 aspect-square hover:bg-[#1a1a1a] transition">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-6 h-6">
      ...
      <div className="fixed bottom-0 w-full bg-black border-t border-gray-900 flex items-center justify-between px-6 py-3 pb-6">
        ...
        <Link to="/pagar" className="flex flex-col items-center gap-1 text-gray-500 hover:text-gray-300 transition">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 19.5 15-15m0 0H8.25m11.25 0v11.25" />
          </svg>
        ...
        <Link to="/poder" className="flex flex-col items-center gap-1 text-gray-500 hover:text-gray-300 transition">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
